...
use lindera_unidic_builder::UnidicBuilder;
    ...
    let app = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("INPUT_DIR")
                .help("The directory where the UniDic source containing.")
        ...
        .arg(
            Arg::with_name("OUTPUT_DIR")
                .help("The directory where the UniDic binary for Lindera is output.")
